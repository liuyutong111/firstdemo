        ...
        <el-table ref="multipleTable" :data="tableData">
          ...
          <el-table-column prop="caozuo" align="center" label="操作" show-overflow-tooltip>
            <template slot-scope="scope">
             ...
             <span>
                <img src="../../imgs/userimg/del.png" alt=""  @click="removess(scope.$index,scope.row)"> 
             </span>
              </template>
          </el-table-column>
        </el-table>
      ...
      <!-- 添加用户 -->
          ...
          <el-dialog title="添加用户" :visible.sync="centerDialogVisibles" width="60%" center>
           ...
           <el-row :gutter="20">
              ...
              <el-col :span="14">
                <div class="grid-content bg-purple">
                  <el-select v-model="ruleForm.value_zu" placeholder="请选择" @change="indexsss($event,index)">
                    <el-option
  ...
  methods: {
    ...
    indexsss (ids) {
      ...
      if ( ids !== '') {
        this.optionsds = this.optionsd[this.z].child
        console.log(this.optionsds)
        this.indexId = this.optionsds[this.s].groupId
        // console.log(this.indexId)
      }
    },
